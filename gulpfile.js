...
// ЗАДАЧА: Копирование файлов с данными
gulp.task('data', function () {
  return gulp.src([
    ...
    .pipe(plumber({ errorHandler: onError }))
    .pipe(gulp.dest(dirs.build + '/data'));
});
...
gulp.task('js', function () {
  return gulp.src([
      ...
      // dirs.source + '/js/html2canvas.min.js',
      ...
      dirs.source + '/js/digitsValidation.js',
...
gulp.task('build', gulp.series(                             // последовательно:
  ...
  'svgstore',
  gulp.parallel('sass', 'img', 'js', 'data', 'css:fonts:woff', 'css:fonts:woff2'),
